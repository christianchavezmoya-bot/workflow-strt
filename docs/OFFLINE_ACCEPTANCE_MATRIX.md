...
**Mac agent:** copy-paste instructions in [`archive/prompts/IOS_MAC_AGENT_OFFLINE_SYNC_UX_PROMPT.md`](./archive/prompts/IOS_MAC_AGENT_OFFLINE_SYNC_UX_PROMPT.md) (merged #37). **Current staging:** [`MAC_AGENT_DOCKER_STAGING_PROMPT.md`](./MAC_AGENT_DOCKER_STAGING_PROMPT.md). Index: [`AGENT_RETEST_INDEX.md`](./AGENT_RETEST_INDEX.md).
