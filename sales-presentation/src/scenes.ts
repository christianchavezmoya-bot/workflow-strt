...
export const SCENES: Scene[] = [
  ...
  },
  {
    ...
    subtitle: "Flag blocking or observation issues, right on the step",
    journeyStep: 6,
    bullets: [
      "Flag issue on any step — blocking, observation, or scope variation",
      "Set severity, add a description & attach a photo or video",
      "High = blocking: the run can't complete until it's resolved",
    ],
    shots: [{ src: `${H}/flag-issue.png`, label: "Flag issue on this step" }],
  },
  {
    id: 15, section: "journey", layout: "journey", audio: "audio/scene-15.mp3",
    tag: "User Journey", title: "Step 7 — Add Photo from Phone",
    subtitle: "Scan the QR to upload from any phone",
    journeyStep: 7,
    bullets: [
      "Open the Add-from-phone QR from the runner or photo panel",
      "Scan with any phone camera — no app install needed",
      "Photos upload straight to the run's pending photo steps",
    ],
    shots: [{ src: `${H}/phone-upload.png`, label: "Add from phone — QR handoff" }],
  },
  {
