...
export default function RecoveryCenter() {
  ...
  const [recycleType, setRecycleType] = useState<"all" | "project" | "asset" | "document">("all");
  ...
  return (
    <Stack spacing={2}>
      ...
      <Alert severity="info">
        Database backups only contain the SQLite data file. Library documents can be selectively restored from backup only if their physical file still exists in server storage. New document deletions now go to the recycle bin instead of being removed immediately.
      </Alert>
