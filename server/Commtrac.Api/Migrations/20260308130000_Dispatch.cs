...
namespace Commtrac.Api.Migrations
{
    ...
    public partial class Dispatch : Migration
    {
        ...
        {
            migrationBuilder.Sql("DROP TABLE IF EXISTS DeliveryEvents");
            migrationBuilder.Sql("DROP TABLE IF EXISTS DispatchLines");
            migrationBuilder.Sql("DROP TABLE IF EXISTS DispatchOrders");
        }
    }
}
