...
/** Start workspace immediately; defer heavier reads by 400–1200 ms. */
export async function runStaggeredDashboardLiveRefresh(tasks: DashboardLiveRefreshTasks): Promise<void> {
