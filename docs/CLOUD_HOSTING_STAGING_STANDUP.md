...
Fresh Docker volume seeds: 2 offices, 2 customers (BHP/Mining), 3 Strata divisions, **1 product (AIM-100 under Strata Connect)**, `Chambers_default` workflow. No tips/documents. No starter project. Admin/PM require password change on first login.
