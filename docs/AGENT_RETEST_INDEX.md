...
|-------|--------|-----|------------|----------------|
| **Cloud hosting AWS plan** | **`main` @ `c54c0a7+`** (merged #166–#169) | #166–#169 ✅ | [`IOS_MAC_AGENT_CLOUD_HOSTING_PROMPT.md`](./IOS_MAC_AGENT_CLOUD_HOSTING_PROMPT.md) | [`WINDOWS_AGENT_CLOUD_HOSTING_PROMPT.md`](./WINDOWS_AGENT_CLOUD_HOSTING_PROMPT.md) |
